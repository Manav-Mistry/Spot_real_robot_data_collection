...
Usage:
    python3 collect_joint_and_imu_data.py 192.168.80.3 --experiment_name loop_test --output_dir /home/nerve/Desktop/data_collected/temp
...
def main():
    ...
    parser.add_argument('--experiment_name', required=True,
                        help='Name of your experiment (used in output filename)')
